"""
Solve lasso regularized least square by accelerated gradient method for the smoothed primal problem.
"""

import numpy

def l1_fast_smooth_grad_sqrt(x0, A, b, mu, options):
    m, n = A.shape
